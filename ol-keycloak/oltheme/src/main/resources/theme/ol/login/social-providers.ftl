    ...
    <div id="kc-social-providers" class="${properties.kcFormSocialAccountSectionClass!}">
        <div class="${properties.kcFormSocialAccountListClass!} <#if social.providers?size gt 3>${properties.kcFormSocialAccountListGridClass!}</#if>">
            <#list social.providers as p>
                <div class="${properties.kcFormSocialAccountListItemClass!}">
      <a id="social-${p.alias}" class="${properties.kcButtonClass!} pf-m-secondary ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} <#if social.providers?size gt 3>${properties.kcFormSocialAccountGridItem!}</#if>" aria-label="${p.displayName}"
                        ...
                        <#if p.iconClasses?has_content>
                            <#switch p.alias>
                                ...
                                <#case "paypal">
                                    ...
                                    <#break>
                                <#case "touchstone-idp">
                                    <svg viewBox="0 0 1680 1040" aria-hidden="true" style="height: 22px">
